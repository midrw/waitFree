  ...
  return (
    data.map((item, i) => {
      ...
      return [
        <tr>
          <td>{count}</td>
          <td onClick={deleteData}>{item.id}</td>
          <td>{item.people}</td>
        </tr>
      ]
    })
      ...
      <div>
        ...
        <div>
          <div className="left">
            ...
            <div onClick={this.session} className="startBtn button">
